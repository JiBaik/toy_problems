...
describe('asyncMap Toy Problem', () => {
  describe('asyncMap', () => {
    it('should exist and be a function', () => {
      expect(solution.asyncMap).toBeDefined;
      expect(solution.asyncMap).to.be.a('function');
    });
    ...
    var res;
    solution.asyncMap([wait2For2, wait3For1], function(arr){
      res = arr;
  ...
  it('should handle more than two async functions in the correct order', function(done) {
    ...
    var res;
    solution.asyncMap([wait3For1, wait2For2, wait1For3, wait5For4, wait1For5], function(arr){
      res = arr;
